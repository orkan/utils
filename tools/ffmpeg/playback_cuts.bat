@echo off
REM =================================================
REM FFmpeg show cut positions (c) @Year@ Orkan
REM -------------------------------------------------
...
echo **************************************************************************
echo    Tool: FFmpeg show cut positions
echo    Desc: Compute cut positions in joined video from video parts filenames
echo   Usage: %~nx0 ^<Videos dir^>
echo **************************************************************************
echo.

REM Import: --------------------------------------------
REM For shortcuts (*.lnk) the dropped file path is always added at the end (by Windows)
REM So <Video dir> must be the last param
set HOMEDIR=%~1
